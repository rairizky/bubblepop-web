...
<div class="row mbn-30">
    ...
    <div class="col-xlg-4 col-lg-12 col-12 mb-30">
        <div class="box">
            <div class="box-head">
                <h4 class="title">Add Topping</h4>
            </div>
            <div class="box-body">
                <div class="form">
                    <form action="{{ route('panel.product.store.topping') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row row-10 mbn-20">
                            ...
                            <div class="col-sm-12 col-12 mb-20 d-flex justify-content-end">
                                <button class="btn btn-primary">Add Topping</button>
                            </div>
                        </div>
                    </form>
                </div>
