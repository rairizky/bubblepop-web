...
<div class="row mbn-30">
    ...
    <div class="col-xlg-4 col-lg-12 col-12 mb-30">
        <div class="box">
            ...
            <div class="box-body">
                <div class="form">
                    <form action="{{ route('panel.promo.update', $get_promo->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row row-10 mbn-20">
                            <div class="col-sm-12 col-12 mb-20">
                                ...
                                @endif
                                <input type="text" name="title" class="form-control" placeholder="Promo title..." autocomplete="off" value="{{ $get_promo->title }}">
                            </div>
                            <div class="col-sm-12 col-12 mb-20">
                                <label>Image</label>
                                @if ($errors->has('image'))
                            ...
                            <div class="col-sm-12 col-12 mb-20">
                                ...
                                @endif
                                <textarea name="description" cols="30" rows="10" class="form-control" placeholder="Desc promo...">{{ $get_promo->description }}</textarea>
                            </div>
                            <div class="col-sm-12 col-12 mb-20">
                                ...
                                @endif
                                <input type="date" name="promo_start" class="form-control" value="{{ $get_promo->promo_start }}">
                            </div>
                            <div class="col-sm-12 col-12 mb-20">
                                ...
                                @endif
                                <input type="date" name="promo_end" class="form-control" value="{{ $get_promo->promo_end }}">
                            </div>
