...
<div class="row mbn-30">
    ...
    <div class="col-xlg-4 col-lg-12 col-12 mb-30">
        <div class="box">
            ...
            <div class="box-body">
                <div class="form">
                    <form action="{{ route('panel.category.updatecategory', $find->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row row-10 mbn-20">
                            <div class="col-sm-12 col-12 mb-20">
                                ...
                                @endif
                                <input type="text" name="name" value="{{ $find->name }}" class="form-control" placeholder="eg: dessert">
                            </div>
